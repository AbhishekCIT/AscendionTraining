...
public class LabEx1_2 {     //class Student {}
    ...
    public LabEx1_2(int studentId, String studentName, String city, int marks1,int marks2, int marks3, float feePerMonth, boolean isEligibleForScholarship) {
    ...
    public boolean isEligibleForScholarship() {
        return marks1 >= 80 && marks2 >= 80 && marks3 >= 80;
    }
...
class TestMain {
    ...
    private static LabEx1_2[] getLabEx12s() {
        LabEx1_2 s1 = new LabEx1_2();
        LabEx1_2 s2 = new LabEx1_2();
        LabEx1_2 s3 = new LabEx1_2();

        LabEx1_2 s4 = new LabEx1_2(10,"Abhishek","Tirupur",100,100,100,1000.0f,true);
        ...
        return new LabEx1_2[]{s1, s2, s3 , s4};
    }
}
